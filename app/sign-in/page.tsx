  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      if (mode === "sign-in") {
        ...
        setMessage("Signed in. Redirecting to your drafts...");
        router.push("/drafts");
        router.refresh();
        return;
      }
      ...
      /*
        With email confirmation disabled, Supabase returns a session and we
        can send the user straight to the app. With confirmation enabled,
        data.session is null and the user must check their email first.
      */
      if (data.session) {
        setMessage("Account created. Redirecting to your drafts...");
        router.push("/drafts");
        router.refresh();
        return;
      }
